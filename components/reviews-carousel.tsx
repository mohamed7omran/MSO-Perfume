...
const featuredReviews = [
  {
    ...
    rating: 5,
    review:
      "خدمة العملاء ممتازة والتوصيل سريع. العطر تحفة والعلبة شيك جدًا. تجربة تسوّق ممتازة.",
    product: "عطر تمبتيشن",
  },
  {
    id: 2,
    ...
    rating: 4,
    review:
      "من أرقى العطور النسائية اللي جربتها. ريحة ناعمة وأنثوية وبتفضل طول اليوم. مبسوطة جدًا باختياري.",
    product: "شانيل N°5",
  },
  {
    id: 3,
    ...
    rating: 5,
    review:
      "عطر جميل ومميز، ريحتُه بتقعد كتير. التغليف شيك والتوصيل وصل بسرعة.",
